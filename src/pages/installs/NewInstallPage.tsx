  ...
  return (
    <div className="flex flex-col gap-8 p-8">
      <div className="flex items-center gap-2">
        <Link
          className="cursor-pointer rounded p-1 text-neutral-400 transition hover:bg-neutral-800 hover:text-neutral-200"
          to="/installs"
        >
...
function VersionCard({ version }: { version: Version }) {
  ...
  return (
    <div className="flex items-center gap-2 rounded border border-white/10 p-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          className="cursor-pointer rounded bg-blue-500 px-2 py-1 font-semibold transition hover:bg-blue-600 disabled:cursor-default disabled:bg-neutral-900"
